    ...
    <div className={`min-h-screen transition-colors duration-300 ${
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            ...
            <div className="md:hidden flex items-center gap-2">
              ...
              >
                {mobileMenuOpen ? <X size={24} className={isDark ? 'text-white' : 'text-slate-900'} /> : <Menu size={24} className={isDark ? 'text-white' : 'text-slate-900'} />}
              </button>
            </div>
          </div>

          {mobileMenuOpen && (
            <div className={`md:hidden py-4 space-y-2 border-t ${isDark ? 'border-gray-700' : 'border-slate-200'}`}>
      ...
      <section id="education" className="py-20 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="space-y-8">
            <div className={`rounded-xl shadow-lg p-8 hover:shadow-xl transition-shadow border-l-4 border-blue-600 ${isDark ? 'bg-gray-800' : 'bg-white'}`}>
              <div className="flex flex-col md:flex-row md:items-start md:justify-between gap-4 mb-4">
                <div className="flex items-start gap-4">
                  <img src="/Université_Lyon_1_(logo).svg" alt="Lyon 1" className="w-16 h-16 object-contain" />
                  <div>
                    <h3 className={`text-2xl font-bold ${isDark ? 'text-white' : 'text-slate-900'}`}>Master Informatique</h3>
                    <p className={`text-lg ${isDark ? 'text-gray-300' : 'text-slate-600'}`}>Université Claude Bernard Lyon 1</p>
                  </div>
                </div>
                <span className="inline-block px-4 py-2 bg-blue-100 text-blue-800 rounded-full font-medium">Depuis Sept. 2025</span>
              </div>
              <p className={isDark ? 'text-gray-400' : 'text-slate-600'}>Lyon, France</p>
            </div>

            <div className={`rounded-xl shadow-lg p-8 hover:shadow-xl transition-shadow border-l-4 border-cyan-600 ${isDark ? 'bg-gray-800' : 'bg-white'}`}>
              <div className="flex flex-col md:flex-row md:items-start md:justify-between gap-4 mb-4">
                <div className="flex items-start gap-4">
                  <img src="/Université_d'Avignon_(logo).png" alt="Avignon" className="w-16 h-16 object-contain" />
                  <div>
                    <h3 className={`text-2xl font-bold ${isDark ? 'text-white' : 'text-slate-900'}`}>Licence Informatique</h3>
                    <p className={`text-lg ${isDark ? 'text-gray-300' : 'text-slate-600'}`}>Université d'Avignon</p>
                  </div>
                </div>
            ...
            <div className={`rounded-xl shadow-lg p-8 hover:shadow-xl transition-shadow border-l-4 border-slate-600 ${isDark ? 'bg-gray-800' : 'bg-white'}`}>
              <div className="flex flex-col md:flex-row md:items-start md:justify-between gap-4 mb-4">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h3 className={`text-2xl font-bold ${isDark ? 'text-white' : 'text-slate-900'}`}>Classe Préparatoire Intégrée</h3>
                    <p className={`text-lg ${isDark ? 'text-gray-300' : 'text-slate-600'}`}>ESI - École Supérieure en Informatique</p>
                  </div>
                </div>
                <span className="inline-block px-4 py-2 bg-slate-100 text-slate-800 rounded-full font-medium">Sept. 2021 - Juin 2023</span>
              </div>
              <p className={`mb-2 ${isDark ? 'text-gray-400' : 'text-slate-600'}`}>Algérie</p>
              <p className={isDark ? 'text-gray-300' : 'text-slate-700'}>Membre du pôle relations externes - Club Ingeniums : Organisation de CTFs et hackathons</p>
            </div>

            <div className={`rounded-xl shadow-lg p-8 hover:shadow-xl transition-shadow border-l-4 border-green-600 ${isDark ? 'bg-gray-800' : 'bg-white'}`}>
              <div className="flex flex-col md:flex-row md:items-start md:justify-between gap-4 mb-4">
                <div>
                  <h3 className={`text-2xl font-bold ${isDark ? 'text-white' : 'text-slate-900'}`}>Stage de Recherche</h3>
              ...
              <p className={`font-medium mb-2 ${isDark ? 'text-gray-300' : 'text-slate-700'}`}>Approximate Bayesian Computation pour les processus de Hawkes</p>
              <p className={isDark ? 'text-gray-400' : 'text-slate-600'}>Implémentation d'algorithmes ABC en R et Python pour l'inférence bayésienne. Application à des cas réels en finance et neurosciences.</p>
            </div>
          </div>
        </div>
      </section>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div className={`rounded-xl shadow-lg overflow-hidden hover:shadow-2xl transition-all transform hover:-translate-y-2 border ${
              ...
              <div className="p-8">
                ...
                <h3 className={`text-2xl font-bold mb-3 ${isDark ? 'text-white' : 'text-slate-900'}`}>Chatbot RH Intelligent</h3>
            ...
            <div className={`rounded-xl shadow-lg overflow-hidden hover:shadow-2xl transition-all transform hover:-translate-y-2 border ${
              ...
              <div className="p-8">
                ...
                <h3 className={`text-2xl font-bold mb-3 ${isDark ? 'text-white' : 'text-slate-900'}`}>StudyHive</h3>
                <p className={`mb-4 leading-relaxed ${isDark ? 'text-gray-300' : 'text-slate-600'}`}>
            ...
            <div className={`rounded-xl shadow-lg overflow-hidden hover:shadow-2xl transition-all transform hover:-translate-y-2 border ${
              ...
              <div className="p-8">
                ...
                <h3 className={`text-2xl font-bold mb-3 ${isDark ? 'text-white' : 'text-slate-900'}`}>Clone de Wordle Intelligent</h3>
                <p className={`mb-4 leading-relaxed ${isDark ? 'text-gray-300' : 'text-slate-600'}`}>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div className={`rounded-xl shadow-lg p-8 hover:shadow-xl transition-shadow ${isDark ? 'bg-gray-800' : 'bg-white'}`}>
              ...
              <div className="flex flex-wrap gap-2">
                <span className={`px-3 py-1 rounded-lg text-sm ${isDark ? 'bg-gray-700 text-gray-300' : 'bg-slate-100 text-slate-700'}`}>Python</span>
                <span className={`px-3 py-1 rounded-lg text-sm ${isDark ? 'bg-gray-700 text-gray-300' : 'bg-slate-100 text-slate-700'}`}>Pandas</span>
                <span className={`px-3 py-1 rounded-lg text-sm ${isDark ? 'bg-gray-700 text-gray-300' : 'bg-slate-100 text-slate-700'}`}>NumPy</span>
                <span className={`px-3 py-1 rounded-lg text-sm ${isDark ? 'bg-gray-700 text-gray-300' : 'bg-slate-100 text-slate-700'}`}>Scikit-learn</span>
                <span className={`px-3 py-1 rounded-lg text-sm ${isDark ? 'bg-gray-700 text-gray-300' : 'bg-slate-100 text-slate-700'}`}>NLP</span>
                <span className={`px-3 py-1 rounded-lg text-sm ${isDark ? 'bg-gray-700 text-gray-300' : 'bg-slate-100 text-slate-700'}`}>HuggingFace</span>
                <span className={`px-3 py-1 rounded-lg text-sm ${isDark ? 'bg-gray-700 text-gray-300' : 'bg-slate-100 text-slate-700'}`}>CNN/MLP</span>
              </div>
            </div>
            ...
            <div className={`rounded-xl shadow-lg p-8 hover:shadow-xl transition-shadow ${isDark ? 'bg-gray-800' : 'bg-white'}`}>
              ...
              <div className="flex flex-wrap gap-2">
                <span className={`px-3 py-1 rounded-lg text-sm ${isDark ? 'bg-gray-700 text-gray-300' : 'bg-slate-100 text-slate-700'}`}>React.js</span>
                <span className={`px-3 py-1 rounded-lg text-sm ${isDark ? 'bg-gray-700 text-gray-300' : 'bg-slate-100 text-slate-700'}`}>JavaScript</span>
                <span className={`px-3 py-1 rounded-lg text-sm ${isDark ? 'bg-gray-700 text-gray-300' : 'bg-slate-100 text-slate-700'}`}>TypeScript</span>
                <span className={`px-3 py-1 rounded-lg text-sm ${isDark ? 'bg-gray-700 text-gray-300' : 'bg-slate-100 text-slate-700'}`}>HTML/CSS</span>
                <span className={`px-3 py-1 rounded-lg text-sm ${isDark ? 'bg-gray-700 text-gray-300' : 'bg-slate-100 text-slate-700'}`}>Tailwind CSS</span>
                <span className={`px-3 py-1 rounded-lg text-sm ${isDark ? 'bg-gray-700 text-gray-300' : 'bg-slate-100 text-slate-700'}`}>Bootstrap</span>
              </div>
            </div>
            ...
            <div className={`rounded-xl shadow-lg p-8 hover:shadow-xl transition-shadow ${isDark ? 'bg-gray-800' : 'bg-white'}`}>
              ...
              <div className="flex flex-wrap gap-2">
                <span className={`px-3 py-1 rounded-lg text-sm ${isDark ? 'bg-gray-700 text-gray-300' : 'bg-slate-100 text-slate-700'}`}>Node.js</span>
                <span className={`px-3 py-1 rounded-lg text-sm ${isDark ? 'bg-gray-700 text-gray-300' : 'bg-slate-100 text-slate-700'}`}>Express.js</span>
                <span className={`px-3 py-1 rounded-lg text-sm ${isDark ? 'bg-gray-700 text-gray-300' : 'bg-slate-100 text-slate-700'}`}>Spring Boot</span>
                <span className={`px-3 py-1 rounded-lg text-sm ${isDark ? 'bg-gray-700 text-gray-300' : 'bg-slate-100 text-slate-700'}`}>Flask</span>
                <span className={`px-3 py-1 rounded-lg text-sm ${isDark ? 'bg-gray-700 text-gray-300' : 'bg-slate-100 text-slate-700'}`}>MongoDB</span>
                <span className={`px-3 py-1 rounded-lg text-sm ${isDark ? 'bg-gray-700 text-gray-300' : 'bg-slate-100 text-slate-700'}`}>PostgreSQL</span>
              </div>
            </div>
            ...
            <div className={`rounded-xl shadow-lg p-8 hover:shadow-xl transition-shadow ${isDark ? 'bg-gray-800' : 'bg-white'}`}>
              ...
              <div className="flex flex-wrap gap-2">
                <span className={`px-3 py-1 rounded-lg text-sm ${isDark ? 'bg-gray-700 text-gray-300' : 'bg-slate-100 text-slate-700'}`}>Git</span>
                <span className={`px-3 py-1 rounded-lg text-sm ${isDark ? 'bg-gray-700 text-gray-300' : 'bg-slate-100 text-slate-700'}`}>Docker</span>
            ...
            <div className={`rounded-xl shadow-lg p-8 hover:shadow-xl transition-shadow ${isDark ? 'bg-gray-800' : 'bg-white'}`}>
              <h3 className={`text-xl font-bold mb-6 flex items-center gap-3 ${isDark ? 'text-white' : 'text-slate-900'}`}>
                <div className={`w-10 h-10 rounded-lg flex items-center justify-center ${isDark ? 'bg-gray-700' : 'bg-slate-100'}`}>
                  <span className={isDark ? 'text-gray-300' : 'text-slate-600'}>🌐</span>
                </div>
                Langues
              </h3>
              <div className="space-y-3">
                <div>
                  <p className={`font-medium ${isDark ? 'text-white' : 'text-slate-900'}`}>Anglais</p>
                  <p className={`text-sm ${isDark ? 'text-gray-400' : 'text-slate-600'}`}>C2 - Certifié LanguageCert (2025)</p>
                </div>
                <div>
                  <p className={`font-medium ${isDark ? 'text-white' : 'text-slate-900'}`}>Français</p>
                  <p className={`text-sm ${isDark ? 'text-gray-400' : 'text-slate-600'}`}>Courant</p>
                </div>
              </div>
            </div>
      ...
      <section id="contact" className={`py-20 px-4 sm:px-6 lg:px-8 ${isDark ? 'bg-gray-800' : 'bg-white'}`}>
        <div className="max-w-4xl mx-auto">
          ...
          <div className="mt-12 text-center">
            <p className={`mb-4 ${isDark ? 'text-gray-400' : 'text-slate-600'}`}>À la recherche d'une alternance à partir de septembre 2025</p>
            <a
              href="/CV_Anis.pdf"
              download
      ...
      <footer className={`py-8 px-4 ${isDark ? 'bg-gray-900' : 'bg-slate-900'}`}>
        <div className="max-w-7xl mx-auto text-center">
          <p className={isDark ? 'text-gray-400' : 'text-slate-300'}>© 2025 Anis BELAGGOUN. Tous droits réservés.</p>
        </div>
      </footer>
